      ...
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Ticket Shop', link: '/guide/ticket-shop' },
            { text: 'Game Passes', link: '/guide/game-passes' },
            { text: 'Cosmetics', link: '/guide/cosmetics' },
            { text: 'Completion Tools', link: '/guide/completion-tools' },
            { text: 'Boost & Practice Tools', link: '/guide/boost-items' },
          ],
        },
        {
          text: 'Players',
          items: [
            ...
            { text: 'Ring Select', link: '/guide/ring-select' },
